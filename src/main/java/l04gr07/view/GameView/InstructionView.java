...
public class InstructionView extends MenuViewer {
    ...
    public void draw() throws IOException {
        ...
        drawText(new Position(1,7),"being catch first","#FFFFFF");
        ...
        drawText(new Position(2,17),"'E' -> break/create walls by player2", "#FFFFFF");
        drawText(new Position(1,18),"to the last selected direction","#FFFFFF");
        drawText(new Position(2,19),"'E' -> break/create walls by player in","#FFFFFF");
        drawText(new Position(1,20),"Huge IceCream mode to the last direction","#FFFFFF");
        drawText(new Position(2,21),"Arrows -> throw iceshot by player in","#FFFFFF");
        drawText(new Position(1,22),"Huge Icecream mode to the last direction","#FFFFFF");


        drawText(new Position(10,24),"( Press 'q' to EXIT )","#FFFFFF");
        screen.refresh();
    }
}
